...
write.csv(otu_table, file.path(save_folder, "otu_table_alr.csv"), row.names = TRUE)

# Guardar sample_data en un archivo CSV
write.csv(data.frame(sample_data), file.path(save_folder, "sample_data_alr.csv"), row.names = TRUE)
```
