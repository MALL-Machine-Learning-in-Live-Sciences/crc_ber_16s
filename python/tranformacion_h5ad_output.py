...
ad = anndata.read_h5ad("C:/Users/Carla/Desktop/4o/Q1/TFG/crc_ber_16s/python/output_alr.h5ad")
...
otu_table_df.to_csv(os.path.join(output_directory, "otu_table_alr.csv"))
sample_data_df.to_csv(os.path.join(output_directory, "sample_data_alr.csv"))
